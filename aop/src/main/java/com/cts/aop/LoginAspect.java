...
public class LoginAspect {
	...
	// Type your code here
	@Around("execution(* com.cts.aop.EasyBank.doWithdraw(..))")
	...
	// Type your code here
	@Before("execution(* com.cts.aop.EasyBank.showBalance(..)) || execution(* com.cts.aop.EasyBank.doDeposit(..))")
	...
	// Type your code here
	@AfterReturning("execution(* com.cts.aop.EasyBank.doChangePin(..))")
	public void afterPinChange() {
		System.out.println("You have successfully changed your pin");
	}

	// Type your code here
	@AfterThrowing("execution(* com.cts.aop.EasyBank.*(..))")
