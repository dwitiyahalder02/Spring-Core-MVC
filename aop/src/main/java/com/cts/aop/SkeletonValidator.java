...
validateClassName("com.cts.aop.AopConfig");
		
		validateClassName("com.cts.aop.EasyBank");
		validateMethodSignature("doWithdraw:void,showBalance:void,doDeposit:void,doChangePin:void","com.cts.aop.EasyBank");

		validateClassName("com.cts.aop.LoginAspect");
		validateMethodSignature("validateWithdraw:void,validateBalance:void,afterPinChange:void,afterWrongPin:void","com.cts.aopLoginAspect");
